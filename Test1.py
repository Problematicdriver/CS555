...
for individual_id in sorted(individuals):
    ...
    individual_table.add_row([current_individual_id, name, gender, spouse_id, children])
...
for families_id in sorted(families):
    ...
    families_table.add_row([current_family_id, husband_id, husband_name, wife_id, wife_name, children])
